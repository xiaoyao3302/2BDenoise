...
from train_utils import filtering_selection_general
from tensorboardX import SummaryWriter  
from data.dataloader_breast_preprocess import BUSI_Dataset, BUS_Dataset
...
parser.add_argument('--use_filtering', type=str2bool, default=False, help='here: only the class balanced sampling')
...
parser.add_argument('--exp_name', type=str, default='test_new_loader_right', help='Name of the experiment')
...
for epoch in range(start_epoch, args.epochs):
    ...
    for data_all in train_loader:
        ...
        if args.use_filtering:
            filtered_mask = filtering_selection_general(args, mask)
    ...
    if  val_results_mean_IoU > best_IoU_mean:
        ...
        io.save_model(model, epoch, mode='mean')
        best_mean_model = copy.deepcopy(model)
