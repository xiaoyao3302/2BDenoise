...
#     from .sync_batchnorm import SynchronizedBatchNorm3d
# except:
#     print('cannot import SynchronizedBatchNorm3d')
#     pass
...
class MFNet(nn.Module): #
    ...
    def __init__(self, args):
        ...
        c = args.DMFNet_c
        n = args.DMFNet_n
        channels = args.DMFNet_channels
        groups = args.DMFNet_groups
        norm = args.DMFNet_norm
...
class DMFNet(MFNet): # softmax
    ...
    def __init__(self, args):
        super(DMFNet, self).__init__(args)
...
class DMFNet_cls(nn.Module):
    def __init__(self, args):
        super(DMFNet_cls, self).__init__()
