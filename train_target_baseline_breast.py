...
parser.add_argument('--use_confident_filtering', type=str2bool, default=False, help='filter out noisy pixels')
parser.add_argument('--use_balance_filtering', type=str2bool, default=False, help='decrease the number of the remained background pixels')
parser.add_argument('--balance_times', type=int, default=1, help='number of remained background pixels should not exceed k times of the foreground pixels')
...
parser.add_argument('--use_noisy_filtering', type=str2bool, default=False, help='apply class balance filtering on warm up or noisy stream (no confident, just class balance)')
